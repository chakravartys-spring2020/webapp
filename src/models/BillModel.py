...
from .FileModel import FileSchema
...
class BillModel(db.Model):
  ...
  files = db.relationship('FileModel', backref = 'bills', lazy = True)
  ...
  @staticmethod
  def delete_one_bill(value):
      Bills.query.filter_by(id = value).delete()
      db.session.commit()
...
class BillSchema(Schema):
  ...
  files = fields.Nested(FileSchema, many = False)